...
<div class="section">
    <div class="container">
        ...
        <div class="box-gmaps">
            <iframe src="<?= $d->google_maps ?>" frameborder="0" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></iframe>
        </div>
