                   ...
                   <?php 
                        if(isset($_POST['submit'])){
                            ...
                            if($_FILES['logo_baru']['name'] != ''){
                                ...
                                $allowtype_logo = array('png', 'jpg', 'jpeg', 'gif');

                                if(!in_array($formatfile_logo, $allowtype_logo)){
                                    echo '<div class="alert alert-error">Format file logo sekolah tidak diizinkan</div>';

                                    return false;
    
                                }elseif($filesize_logo > 5000000){
                                    echo '<div class="alert alert-error">Format file logo sekolah tidak boleh lebih dari 1MB</div>';
                            ...
                            if($_FILES['favicon_baru']['name'] != ''){
                                ...
                                $allowtype_favicon = array('png', 'jpg', 'jpeg', 'gif');

                                if(!in_array($formatfile_favicon, $allowtype_favicon)){
                                    echo '<div class="alert alert-error">Format file favicon sekolah tidak diizinkan</div>';

                                    return false;
    
                                }elseif($filesize_favicon > 5000000){
                                    echo '<div class="alert alert-error">Format file favicon sekolah tidak boleh lebih dari 1MB</div>';
