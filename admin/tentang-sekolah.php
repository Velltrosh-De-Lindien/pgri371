            ...
            <div class="box">
                ...
                <form action=""  method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
						...
						<textarea name="tentang" id="keterangan" class="input-control" placeholder="Tentang Sekolah"><?= $d->tentang_sekolah ?></textarea>
					</div>               
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            if($_FILES['foto_baru']['name'] != ''){
                                ...
                                if(!in_array($formatfile, $allowtype)){
                                    ...
                                    echo '<div class="alert alert-error">Format file foto sekolah tidak boleh lebih dari 1MB</div>';
